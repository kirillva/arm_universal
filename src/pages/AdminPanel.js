...
export const AdminPanel = () => {
  ...
  const pd_users = React.useMemo(
    ...
    //     Cell: StringCell,
    //   },
      { title: "Логин", accessor: "c_login", Filter: StringFilter, Cell: StringCell },
    //   { accessor: "c_password", title: "c_password", Filter: StringFilter, Cell: StringCell },
      { title: "ФИО", accessor: "c_first_name", Filter: StringFilter, Cell: StringCell },
    ...
    //   { accessor: "c_imei", title: "c_imei", Filter: StringFilter, Cell: StringCell },
      { title: "Описание", accessor: "c_description", Filter: StringFilter, Cell: StringCell },
      { title: "Удален", accessor: "b_disabled", Filter: BoolFilter, Cell: BoolCell, Editor: BoolEditor },
    ...
    //   { title: "n_version", accessor: "n_version", Filter: StringFilter, Cell: StringCell },
      { title: "Телефон", accessor: "c_phone", Filter: StringFilter, Cell: StringCell },
      { title: "e-mail", accessor: "c_email", Filter: StringFilter, Cell: StringCell },
    ],
    []
  );
  ...
  return (
    <div className={classes.content}>
      ...
      <div className={classes.table}>
        <Table title="Список пользователей" columns={pd_users} action="pd_users" editable />
      </div>
    </div>
  );
};
