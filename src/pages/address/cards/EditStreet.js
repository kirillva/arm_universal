      ...
      <>
        <Dialog open={windowOpen} onClose={onClose}>
          ...
          <DialogContent>
            ...
            <Typography style={{ color: "red" }}>Активация/деактивация других улиц происходит сразу, сохранить и отмена относятся к изменениям текущей выбранной улицы</Typography>
          </DialogContent>
          <DialogActions>
            <Button
              variant={"contained"}
